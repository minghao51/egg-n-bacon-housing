...
**Tier 2: Market Analysis** (need aggregated metrics) 4. `analyze_hdb_rental_market.py` 5. `analyze_amenity_impact.py`

**Tier 3: Causal Inference** (need spatial outputs + metrics) 6. `analyze_policy_impact.py` 7. `analyze_lease_decay.py`

**Tier 4: ML/Modeling** (need full feature set) 8. `analyze_feature_importance.py` 9. `market_segmentation_advanced.py`
...
_Report generated by L4_analysis.py_
```
