...
2. **Correlation ≠ Causation:** OLS coefficients show association but cannot establish that school proximity _causes_ higher prices. Selection bias (families choosing good areas) confounds estimates.
