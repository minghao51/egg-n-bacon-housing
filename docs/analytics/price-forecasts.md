...
<div data-chart-metadata="true" data-chart="comparison" data-chart-title="Forecast reliability by segment" data-chart-columns="Accuracy (R²),Error Margin,95% CI Width,Directional Acc"></div>
...
<div data-chart-metadata="true" data-chart="comparison" data-chart-title="Confidence interval width by segment" data-chart-columns="95% CI Width,Actual Coverage"></div>
...
<div data-chart-metadata="true" data-chart="comparison" data-chart-title="Top HDB forecast drivers" data-chart-columns="Importance"></div>
