...
<div data-chart-metadata="true" data-chart="comparison" data-chart-title="Lease band price profile" data-chart-columns="Median Price,Median PSF,Transactions"></div>
...
<div data-chart-metadata="true" data-chart="comparison" data-chart-title="Lease discount by town" data-chart-columns="Short Lease (PSM),Fresh Lease (PSM),Discount %"></div>
...
<div data-chart-metadata="true" data-chart="time-series,comparison" data-chart-title="Empirical vs theoretical lease values" data-chart-columns="Empirical %,Theoretical %,Deviation %"></div>
...
<div data-chart-metadata="true" data-chart="time-series" data-chart-title="Liquidity around the 60-year boundary" data-chart-columns="Median PSM,Transactions,% of Total"></div>
