...
**`logging.basicConfig()` call in `src/data_helpers.py:17` was blocking file logging.**

### Technical Details

1. **`src/data_helpers.py`** imported `logging` and called:
   ```python
...
**Removed `logging.basicConfig()` from `src/data_helpers.py:17`**
...
- `src/data_helpers.py` - Fixed (removed basicConfig)
