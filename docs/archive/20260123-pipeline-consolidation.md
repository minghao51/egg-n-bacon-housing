...
**Date:** 2026-01-23
**Objective:** Consolidate redundant scripts and move notebook logic to `core/pipeline/`

## Overview

This document describes the structural changes made to consolidate the data pipeline codebase, eliminating redundancy and establishing a clean module hierarchy in `core/pipeline/`.
...
2. **Clean architecture** - Pipeline logic in `core/pipeline/`, runners in `scripts/`
