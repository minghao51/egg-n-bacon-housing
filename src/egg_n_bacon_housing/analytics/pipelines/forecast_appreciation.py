# egg_n_bacon_housing/analytics/pipelines/forecast_appreciation.py
"""
...
Usage:
    from egg_n_bacon_housing.analytics.pipelines.forecast_appreciation import run_forecasting_pipeline
