...
def load_prepared_data() -> tuple[pd.DataFrame, pd.DataFrame]:
    ...
    train_path = settings.DATA_DIR / "pipeline" / "L5_price_appreciation_train.parquet"
    test_path = settings.DATA_DIR / "pipeline" / "L5_price_appreciation_test.parquet"
...
def main():
    ...
    comparison_path = (
        settings.DATA_DIR / "analysis" / "price_appreciation_modeling" / "model_comparison.csv"
    )
    ...
    output_dir = settings.DATA_DIR / "analysis" / "price_appreciation_modeling" / "models"
