...
from egg_n_bacon_housing.utils.data_helpers import save_parquet
...
def main():
    ...
    unified_path = settings.DATA_DIR / "pipeline" / "L3" / "housing_unified.parquet"
    ...
    logger.info(
        "   Next step: uv run python -m egg_n_bacon_housing.analytics.price_appreciation_modeling.train_models"
    )
