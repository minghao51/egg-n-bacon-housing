...
class TestGoldLayer:
    ...
    def test_features_with_amenities_derives_real_feature_columns(self, tmp_path, monkeypatch):
    ...
    def test_features_with_amenities_with_empty_geocoded(self, tmp_path):
    ...
    def test_unified_features_returns_dataframe(self, tmp_path):
        ...
        result = features.unified_features(
            features_with_amenities, rental_yield, gold_dir=tmp_path / "gold"
        )
    ...
    def test_unified_features_with_empty_input(self, tmp_path):
