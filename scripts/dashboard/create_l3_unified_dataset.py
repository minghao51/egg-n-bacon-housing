...
Usage:
    uv run python scripts/create_l3_unified_dataset_v2.py
"""
...
def load_hdb_transactions() -> pd.DataFrame:
    ...
    if not path.exists():
        raise FileNotFoundError(f"HDB data not found: {path}")
...
def main():
    ...
    logger.info("=" * 60)
    logger.info("L3 Unified Dataset Creation Pipeline - Enhanced")
    logger.info("=" * 60)
