    ...
    return (
      <div className="rounded-2xl bg-muted/20 py-12 text-center">
        <p className="mb-2 text-muted-foreground">
          No planning areas match the current filters.
        </p>
        <p className="text-sm text-muted-foreground">
          Adjust the filters or clear the search to expand the results.
        </p>
      </div>
    );
  }
        ...
        <table className="min-w-full text-left text-sm">
          <thead className="bg-muted/60 text-xs uppercase tracking-wide text-muted-foreground">
            <tr>
              ...
              {showPriceColumn && (
                <th className="px-3 py-3 font-semibold">Median Price</th>
              )}
              {showVolumeColumn && (
            ...
            {data.map((row) => {
              ...
              return (
                ...
                >
                  ...
                  <td
                    className={`px-3 py-3 font-semibold ${metricTone(selectedMetric, selectedValue)}`}
                  >
                    {selectedValue}
                  </td>
                  {showPriceColumn && (
                      ...
                      {row.propertyMix.total > 0 && (
                        <>
                          <div
                            ...
                            style={{
                              width: `${(row.propertyMix.hdb / row.propertyMix.total) * 100}%`,
                            }}
                          ...
                          <div
                            ...
                            style={{
                              width: `${(row.propertyMix.ec / row.propertyMix.total) * 100}%`,
                            }}
                          ...
                          <div
                            ...
                            style={{
                              width: `${(row.propertyMix.condo / row.propertyMix.total) * 100}%`,
                            }}
