...
export function SegmentGrid({
  ...
  const sortedSegments = useMemo(() => {
    ...
    switch (sortBy) {
      case "yield":
        return sorted.sort(
          (a, b) => b.segment.metrics.avgYield - a.segment.metrics.avgYield,
        );
      case "growth":
        return sorted.sort(
          (a, b) => b.segment.metrics.yoyGrowth - a.segment.metrics.yoyGrowth,
        );
      case "value":
        return sorted.sort(
          (a, b) =>
            a.segment.metrics.avgPricePsf - b.segment.metrics.avgPricePsf,
        );
      case "relevance":
      default:
        return sorted;
