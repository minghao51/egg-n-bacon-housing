...
export const SEGMENT_METRICS = [
  {
    ...
    description:
      "Average price per square foot for planning areas in the selected segment.",
  ...
  },
  {
    ...
    label: "YoY Growth",
    description:
      "Segment-level year-over-year growth used for selection and comparison.",
        ...
        <div className="flex items-center justify-between border-b p-6">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Definitions for the metrics used to rank segments and shortlist
              planning areas.
            </p>
          </div>
          <button
          ...
          {groups.map((group) => (
            <section key={group}>
              ...
              <div className="space-y-4">
                {SEGMENT_METRICS.filter((metric) => metric.group === group).map(
                  (metric) => (
                    <div
                      key={metric.key}
