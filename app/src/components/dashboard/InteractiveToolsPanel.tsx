    ...
    switch (activeTab) {
      case "mrt-cbd":
        return {
          ...
          description:
            "Estimate how MRT and CBD distance pull values up or down for a target area.",
      ...
      case "lease-decay":
        return {
          ...
          description:
            "Check where a property sits on the lease-decay curve and how fast value pressure builds.",
      ...
      case "affordability":
        return {
          ...
          description:
            "Test affordability ranges by income, property type, and town before you shortlist an area.",
      ...
      case "hotspots":
        return {
          ...
          description:
            "Check hotspot and transition-zone signals when you already have towns in mind.",
      ...
      default:
        return {
          ...
          description:
            "Run a scenario before you move back into area ranking or segment discovery.",
    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Use one calculator at a time, get an answer, then jump back into area
          comparison or segment discovery with that result.
        </p>
        {segmentsData?.segments?.length ? (
          <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
            Cross-check your result later against {segmentsData.segments.length}{" "}
            market segments in the discovery flow.
          </p>
        ) : null}
      </div>
      ...
      <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
        ...
        >
          ...
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
            Quantify commute-distance pricing tradeoffs.
          </p>
        </button>
        <button
          type="button"
        ...
        >
          ...
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
            Estimate remaining-lease discount and risk zone.
          </p>
        </button>
        <button
          type="button"
        ...
        >
          ...
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
            Check income capacity before shortlisting.
          </p>
        </button>
        <button
          type="button"
        ...
        >
          ...
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
            Lookup clustering signals for candidate towns.
          </p>
        </button>
      </div>
      ...
      <div className="mt-6 grid gap-4 md:grid-cols-2">
        ...
        >
          {activeTab === "affordability"
            ? "Next: compare areas"
            : "Next: discover matching segments"}
        </a>
      </div>
    </div>
  );
